...
public class OptionsState extends GameState {
	...
	public OptionsState(Engine engine) {
		...
		backButton = new Button(0f, 100f, 600f, 250f, XAlignment.CENTER, YAlignment.BOTTOM);
		...
		uiManager.elements.add(new Text(-120f, 100f, 0f, 0f, XAlignment.CENTER, YAlignment.BOTTOM, "BACK",
