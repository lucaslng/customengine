...
public class Materials {
	public static HashMap<String, Material> createMaterials() {
		...
		materials.put("Exit", new Material(new Texture(FileReader.readImage("exit.png"))));
		...
		materials.put("Wall", new Material(new Texture(FileReader.readImage("wall.jpg"), GL_REPEAT)));
